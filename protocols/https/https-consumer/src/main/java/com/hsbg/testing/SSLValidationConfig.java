...
public class SSLValidationConfig {
    ...
    RestTemplate restTemplate(RestTemplateBuilder builder) {
        return builder
        		.requestFactory(() -> ignoreSSlValidation())
               //.requestFactory(() -> validateSSL())
                .build();
    }
    private HttpComponentsClientHttpRequestFactory ignoreSSlValidation(){
    ...
    /*private HttpComponentsClientHttpRequestFactory validateSSL(){
    	System.out.println("inside validateSSL");
        String location = "D:\\PraiseTheLord\\HSBGInfotech\\Others\\vilas\\microservices1\\protocols\\https\\https-producer\\src\\main\\resources\\https-example.jks";
